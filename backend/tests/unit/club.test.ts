...
import { joinClub, requestJoinClub, approveRequest, denyRequest } from '../../src/utils/club';
...
describe('Club Utils', () => {
    ...
    describe('joinClub', () => {
        ...
        it('should throw an error if the query fails', async () => {
            ...
            await expect(joinClub(mockClubId, mockUserId)).rejects.toThrow('Database Error');
        });
    });
    ...
    describe('requestJoinClub', () => {
        ...
        it('should throw an error if the query fails', async () => {
            ...
            await expect(requestJoinClub(mockClubId, mockUserId)).rejects.toThrow('Database Error');
        });
    });
    ...
    describe('denyRequest', () => {
        ...
        it('should throw an error if the query fails', async () => {
            ...
            await expect(denyRequest(mockRequestId, mockUserId.toString())).rejects.toThrow(
                'Database Error'
            );
        });
    });
