import { generateToken, generateVerificationToken } from '../../src/utils/tokens';
...
describe('Token Utils', () => {
    ...
    describe('generateToken', () => {
        it('should throw an error if SECRET_KEY is missing during function call', () => {
            ...
            expect(() => generateToken(mockPayload)).toThrow('Missing JWT_SECRET environment variable');
        ...
        it('should generate a token if SECRET_KEY is defined', () => {
            ...
            expect(jwt.sign).toHaveBeenCalledWith(mockPayload, 'mockSecret', { expiresIn: '16h' });
    ...
    describe('generateVerificationToken', () => {
        it('should throw an error if SECRET_KEY is missing during function call', () => {
            ...
            expect(() => generateVerificationToken(mockUserId)).toThrow('Missing JWT_SECRET environment variable');
        ...
        it('should generate a verification token if SECRET_KEY is defined', () => {
            ...
            expect(jwt.sign).toHaveBeenCalledWith({ userId: mockUserId }, 'mockSecret', { expiresIn: '1d' });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle JWT sign errors gracefully', () => {
            ...
            expect(() => generateVerificationToken(mockUserId)).toThrow('JWT signing error');
        });
    });
});