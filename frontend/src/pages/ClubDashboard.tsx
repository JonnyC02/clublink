...
const ClubDashboard = () => {
    ...
    const studentCount = data?.memberList?.filter((member: any) => member.studentnumber).length || 0;
    const associateCount = data?.memberList?.filter((member: any) => !member.studentnumber).length || 0;
