    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <p className="text-center mb-4 text-gray-500">Enter your email address to reset your password</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className={`w-full px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        disabled={loading}
                    >
